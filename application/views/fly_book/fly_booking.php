...
function build_passanger_template($airPriceInfoItem){
   $passangerHtml = "";
   for($i = 0; $i < (int)$airPriceInfoItem->passenger_count; $i++){
       $passangerHtml = $passangerHtml.build_passanger_input_template($airPriceInfoItem->passenger_type, $airPriceInfoItem->passenger_type_desc);
   }
   return $passangerHtml;
}

function build_airsegment_template($airsegment_object){
    ...
    $airsegmentHtml = $airsegmentHtml."<span>$airsegment_object->carrier $airsegment_object->flight_number</span>";
    $airsegmentHtml = $airsegmentHtml."<span>$airsegment_object->origin $departure_time</span>";
    $airsegmentHtml = $airsegmentHtml."<span>$airsegment_object->destination $arrival_time</span>";
    $airsegmentHtml = $airsegmentHtml."<span>$flight_time</span>";
    $airsegmentHtml = $airsegmentHtml."<span><strong>$airsegment_object->booking_code  $airsegment_object->booking_cabin_class</strong></span>";
...
function build_journey_template($bookPriceVerifyResponse, $journey){
    $journeyHeader = ""; 
    ...
    if($journey->type == "D"){
     ...
     $airsegmentsHTML = "";
     foreach ($journey->air_segment_items as $airsegment_object){
         $airsegmentsHTML = $airsegmentsHTML.build_airsegment_template($airsegment_object);
 ...
 function build_journey_container_template($bookPriceVerifyResponse){
     $allJourneys = $bookPriceVerifyResponse->verifiedAirPriceSolution->allJourneys;
     $journeyContainerHtml = "";
     foreach ($allJourneys as $journey){
         $journeyContainerHtml = $journeyContainerHtml.build_journey_template($bookPriceVerifyResponse, $journey);
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="span8 passanger-container">
                                ...
                                foreach($bookingPriceVerifiedSolution->verifiedAirPriceSolution->air_price_info_items as $air_price_solution_item){
                                  
                                 echo build_passanger_template($air_price_solution_item);
                                }
                                ?>
                                ...
                                <div class="row price-element">
                                    <div class="span3 passanger-price-total">
                                        <div class="price-total-summary">
                                            ...
                                            <span class="info-value"><span><?php echo $bookingPriceVerifiedSolution->verifiedAirPriceSolution->approximate_base_price ?></span></span>
                                        </div>
                                ...
                                <div class="row price-element">
                                    <div class="span3 passanger-tax-price-total">
                                         <div class="price-total-summary">
                                            ...
                                            <span class="info-value"><?php echo $bookingPriceVerifiedSolution->verifiedAirPriceSolution->taxes ?></span>
                                        </div>
                                         <div class="price-total-detail"></div>
                                    </div>
                                ...
                                <div class="row price-element">
                                    <div class="span3 passanger-all-price-total">
                                          <div class="price-total-summary">
                                            ...
                                            <span class="info-value"><?php echo $bookingPriceVerifiedSolution->verifiedAirPriceSolution->apprixomate_total_price ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
